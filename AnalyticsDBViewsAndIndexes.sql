...
DROP INDEX IF EXISTS renter_traced_map_searches_saved_search_id_idx;
CREATE INDEX renter_traced_map_searches_saved_search_id_idx ON renter_traced_map_searches (saved_search_id);
